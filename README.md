...
- **3D camera** — orbit (drag), zoom (scroll), pan (right-drag); auto-frame; follow centre of mass.
...
No build needed. In the repo settings enable **Pages → Deploy from branch → `main` / root**,
and the site is live at `https://<user>.github.io/3bsim/`.
